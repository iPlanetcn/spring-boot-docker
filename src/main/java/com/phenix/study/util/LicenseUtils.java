...
public class LicenseUtils {
    ...
    private static byte[] sign(RSAPrivateKey pri, byte[] hashed)
        ...
        byte[] src = m.modPow(pri.getPrivateExponent(), pri.getModulus())
                      .toByteArray();
